...
export default function Home() {
  return (
    <div style={{ fontFamily: 'Arial', padding: '2rem', background: '#1a1a1a', color: '#fff' }}>
      <h1 style={{ fontSize: '2rem', marginBottom: '1rem' }}>🥍 JukeSports - Live Lacrosse Scores</h1>
      {games.map((game) => (
        <div key={game.id} style={{ marginBottom: '2rem', padding: '1rem', border: '1px solid #333', borderRadius: '8px' }}>
